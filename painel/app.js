...
const RANK_DATA = [
    ...
    { nivel: 6, pedra: 'Paládio',   emoji: '⍟', cor: '#ced0d4', pr: 1500,   recompensas: ['Acesso a missões Rank Paládio', '+450 Exp.', '+450 Pontos Gear'], narrativa: 'Seu personagem é uma figura de reconhecimento nacional. Suas ações influenciam diretamente grandes acontecimentos e seu nome é respeitado em praticamente qualquer organização.' },
